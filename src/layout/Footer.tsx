            ...
            <div className="max-w-7xl px-4 mx-auto lg:grid lg:grid-cols-5 ">
                ...
                <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        <div>
                            <p>
                                <span className="text-xs tracking-wide uppercase"> Call us </span>

                                <a href="#" className="block text-2xl font-mediu hover:opacity-75 sm:text-3xl">
                                    0123456789
                                </a>
                            </p>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    ...
                                    <li>
                                        <a href="#" className="transition hover:opacity-75"> Help & Support </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li className="flex items-start gap-2">
                                        <MapPin className="mt-0.5 flex-shrink-0" size={19} />
                                        <a href="#" className="transition hover:opacity-75 break-words">
                                            Dhaka, Bangladesh
                                        </a>
                                    </li>

                                    <li className="flex items-start gap-2">
                                        <Phone className="mt-0.5 flex-shrink-0" size={19} />
                                        <a href="#" className="transition hover:opacity-75 break-words">
                                            +880 1234-567890
                                        </a>
                                    </li>
                                    ...
                                    <li className="flex items-start gap-2">
                                        <Mail className="mt-0.5 flex-shrink-0" size={19} />
                                        <a href="mailto:support@gmail.com" className="transition hover:opacity-75 break-words">
                                            support@gmail.com
                                        </a>
                                    </li>
                                </ul>
