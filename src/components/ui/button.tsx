...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded bg-primary px-5 py-3 font-medium shadow-sm transition-colors hover:bg-muted-foreground hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: "h-auto", // because px-5 py-3 already set spacing
