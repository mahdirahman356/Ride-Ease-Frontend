        ...
        <div>
            <div className="flex flex-col py-6 px-6 lg:py-10 mx-auto space-y-6 lg:h-[32rem] md:flex-row items-center mt-6 lg:mt-10">
                <div className="flex flex-col w-full lg:w-1/2">
                    <div className="mr-5">
                        <h1 className="text-4xl lg:text-5xl font-medium">Contact <span className="font-[100]">Us</span></h1>
            ...
            <div className="py-6 px-6 lg:py-10">
                        <h1 className="text-2xl lg:text-3xl font-medium">Send Us <span className="font-[100]">a Message</span></h1>
